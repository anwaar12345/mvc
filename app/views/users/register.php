...
<input type="text" name="name" class="form-control form-control-lg <?php echo (!empty($data['name_err'])) ? 'invalid' : ''; ?>" Required placeholder="Enter Your Name ..." value="<?php echo $data['name']; ?>">
...
<input type="password" name="confirm_password" class="form-control form-control-lg <?php echo (!empty($data['confirmpass_err'])) ? 'invalid' : ''; ?>" Required placeholder="Please Confirm Your Password ..."  value="<?php echo $data['confirm_password']; ?>">
<span class="invalid-feedback"><?php echo $data['confirmpass_err']; ?></span>
